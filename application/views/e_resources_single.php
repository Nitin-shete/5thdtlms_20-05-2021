			...
			<div id="two-columns" class="container">
				<div class="row">
					...
					<article id="content" class="col-xs-12 col-md-9">
						<!-- content h1 -->
						<h1 class="content-h1 fw-semi">Name of The Course</h1>
						<!-- view header -->
								...
								<div class="d-col">
									...
									<div class="post-author">
										...
										<div class="description-wrap">
											<h2 class="author-heading"><a href="#">Faculty</a></h2>
						...
						<section class="sectionRow">
							<h2 class="h6 text-uppercase fw-semi rowHeading">Section-1: Title</h2>
										...
										<h3 class="panel-title fw-normal">
											<a class="accOpener" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
												<span class="accOpenerCol">
													<i class="fas fa-chevron-circle-right accOpenerIcn"></i><i class="fas fa-play-circle inlineIcn"></i> Topic 1<span class="label label-primary text-white text-uppercase">Video</span>
												</span>
									...
									<div class="panel-heading" role="tab" id="headingTwo">
										<h3 class="panel-title fw-normal">
											<a class="accOpener" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												<span class="accOpenerCol">
													<i class="fas fa-chevron-circle-right accOpenerIcn"></i><i class="far fa-file inlineIcn"></i> Topic 2 <span class="label label-success text-white text-uppercase">free</span>
												</span>
												<span class="accOpenerCol hd-phone">
									...
									<div class="panel-heading" role="tab" id="headingThree">
										<h3 class="panel-title fw-normal">
											<a class="accOpener" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
												<span class="accOpenerCol">
													<i class="fas fa-chevron-circle-right accOpenerIcn"></i><i class="fas fa-puzzle-piece inlineIcn"></i> Topic 3<span class="label label-primary text-white text-uppercase"></span>
												</span>
												<span class="accOpenerCol hd-phone">
									...
									<div class="panel-heading" role="tab" id="headingFour">
										<h3 class="panel-title fw-normal">
											<a class="accOpener" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
												<span class="accOpenerCol">
													<i class="fas fa-chevron-circle-right accOpenerIcn"></i><i class="fas fa-play-circle inlineIcn"></i> TOPic 4 <span class="label label-primary text-white text-uppercase">Video</span>
												</span>
												<span class="accOpenerCol hd-phone">
													<span class="tagText bg-primary fw-semi text-white text-uppercase">preview</span>
									...
									<div class="panel-heading" role="tab" id="headingFive">
										<h3 class="panel-title fw-normal">
											<a class="accOpener" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
												<span class="accOpenerCol">
													<i class="fas fa-chevron-circle-right accOpenerIcn"></i><i class="far fa-file inlineIcn"></i> Topic 5 <span class="label label-warning text-white text-uppercase">assessment</span>
												</span>
												<span class="accOpenerCol hd-phone">
						...
						<!-- sectionRow -->
						<section class="sectionRow">
							<h2 class="h6 text-uppercase fw-semi rowHeading">Section-2: Title</h2>
							<!-- sectionRowPanelGroup -->
						...
						<div class="instructorInfoBox">
							<div class="alignleft">
								<a href="#"><img src="http://placehold.it/80x80" alt="Merry Jhonson"></a>
							</div>
							<div class="description-wrap">
								<h3 class="fw-normal"><a href="#">Faculty Name</a></h3>
					...
					<aside class="col-xs-12 col-md-3" id="sidebar">
						...
						<section class="widget widget_box widget_course_select">
							...
							<strong class="price element-block font-lato" data-label="price:">$99</strong>
						...
						<section class="widget widget_categories">
							...
							<ul class="list-unstyled text-capitalize font-lato">
								...
								<li class="cat-item cat-item-6"><a href="#">Category 6</a></li>
								<li class="cat-item cat-item-7"><a href="#">Category7</a></li>
							</ul>
						</section>
						<!-- widget intro -->
						...
						<section class="widget widget_popular_posts">
							...
							<ul class="widget-cources-list list-unstyled">
								<li>
									<a href="<?php echo  base_url(); ?>e_resource/e_resources_single">
										<div class="alignleft">
								...
								<li>
									<a href="<?php echo  base_url(); ?>e_resource/e_resources_single_free">
										<div class="alignleft">
											<img src="http://placehold.it/60x60" alt="image description">
										</div>
										<div class="description-wrap">
